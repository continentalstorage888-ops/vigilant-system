...
const MLSandbox: React.FC = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            const response = await ai.models.generateContent({
                ...
                contents: `You are a sentiment analysis model. Analyze the following text and respond with only one word: "Positive", "Negative", or "Neutral". Do not add any other text or punctuation. Text: "${inputText}"`,
            });
            ...
            console.error(error);
            toast("Failed to analyze sentiment. Check API Key.", "error");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div>
            ...
            <p className="text-sm text-stone-600 dark:text-stone-400 mb-4">Test a simple sentiment analysis model powered by the Gemini API.</p>
...
const SkillsPlaygroundApp: React.FC = () => {
    const [activeTab, setActiveTab] = useState<PlaygroundTab>('data_viz');
