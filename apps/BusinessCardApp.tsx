...
const BusinessCardApp: React.FC = () => {
    ...
    return (
        <div className="h-full flex items-center justify-center bg-stone-100 dark:bg-stone-900 select-none p-4">
            <div className="w-[450px] h-[250px] bg-gradient-to-br from-stone-50 to-stone-200 dark:from-stone-800 dark:to-stone-900 rounded-2xl shadow-2xl flex p-6 transition-all duration-300 ease-in-out hover:shadow-amber-500/20 hover:scale-[1.02]">
                {/* Left Side */}
                <div className="flex flex-col justify-between items-center w-2/5 pr-4 border-r border-stone-300 dark:border-stone-700">
                ...
                {/* Right Side */}
                <div className="w-3/5 pl-6 flex flex-col justify-center text-sm text-stone-700 dark:text-stone-300 space-y-3">
                    <a href={`mailto:${contact.email}`} className="flex items-center gap-2 group">
                        ...
                        <span className="group-hover:text-amber-500 transition-colors">{contact.email}</span>
                    </a>
